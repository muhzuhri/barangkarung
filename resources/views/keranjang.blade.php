...
<body>
    ...
    <section class="keranjang-container">
        <div class="keranjang-item">
            ...
            <img src="img/baju-img/polo1.png" alt="Polo Shirt Uniqlo">
            <div class="item-info">
        ...
        <div class="keranjang-item">
            <input type="checkbox" class="item-check">
            <img src="img/baju-img/polo2.png" alt="Polo Shirt Uniqlo">
            <div class="item-info">
                <h4>Polo Shirt Uniqlo</h4>
                <p>Rp. 90.000</p>
                <small>Tambahkan Kode Voucher ></small>
        ...
        <div class="keranjang-item">
            <input type="checkbox" class="item-check">
            <img src="img/baju-img/polo3.png" alt="Polo Shirt Uniqlo">
            <div class="item-info">
                <h4>Polo Shirt Uniqlo</h4>
                <p>Rp. 90.000</p>
                <small>Tambahkan Kode Voucher ></small>
