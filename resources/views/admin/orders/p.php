...
<div class="order-container">
    ...
    <div class="section-header">
        <img src={{ asset('img/icon/spreadsheet-icon.png') }} alt="Pesanan Terbaru" class="section-icon">
    ...
    <!-- Form Update Status -->
    <form method="POST" action="{{ route('admin.orders.updateStatus', $order->id) }}" class="status-form-pesanan">
        @csrf
        @method('PATCH')
        ...
        <div class="btn-group-perbarui-pesanan">
            <button type="submit" class="btn-submit-perbarui-pesanan">Perbarui</button>
        </div>
    </form>
...
<div class="penutup">
    <p class="penutup-text">
        Sistem ini terus dikembangkan untuk memberikan kemudahan maksimal dalam pengelolaan toko barang karung. Melalui
        pembaruan dan peningkatan fitur, pengguna dapat mengelola stok, transaksi, dan data pelanggan dengan lebih
        efisien. Dengan antarmuka yang sederhana namun fungsional, sistem ini membantu mempercepat proses operasional
        toko sekaligus meminimalkan kesalahan. Jelajahi berbagai fiturnya dan manfaatkan secara optimal untuk mendukung
