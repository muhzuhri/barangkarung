            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    @auth
                        ...
                        <a href="{{ route('pesanan.history') }}"><span class="material-icons">history</span>Riwayat
                            Pesanan</a>
                        <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                            @csrf
                            <button type="submit"
                                style="background: none; border: none; color: #000; font-size: 13px; font-weight: 500; display: flex; align-items: center; gap: 12px; padding: 12px 20px; width: 100%; text-align: left; cursor: pointer; transition: background 0.3s;">
...
<div id="bk-chatbot" data-token="{{ csrf_token() }}"
    ...
    <script>
        (function() {
            ...
            const fullscreenBtn = document.getElementById('bk-chatbot-fullscreen');
            ...
            closeBtn.addEventListener('click', function() {
                ...
                if (isFullscreen) {
                    toggleFullscreen(); // Keluar dari fullscreen saat menutup
                }
            });
