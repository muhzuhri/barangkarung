...
<header class="navbar">
    <div class="navbar-top">
        ...
        <!-- SECTION RIGHT ICON (DESKTOP ONLY) -->
...
<!-- ===== SECTION CATEGORY MENU ===== --> <nav class="category-menu" id="categoryMenu"> <a href="{{ route('beranda') }}" class="{{ request()->routeIs('beranda') ? 'active' : '' }}">Beranda</a> <a href="{{ route('katalog') }}" class="{{ request()->routeIs('katalog') ? 'active' : '' }}">Katalog</a> <a href="{{ route('pesanan') }}" class="{{ request()->routeIs('pesanan') ? 'active' : '' }}">Pesanan</a> <a href="{{ route('pesanan.history') }}" class="{{ request()->routeIs('pesanan.history') ? 'active' : '' }}">Riwayat</a> <a href="{{ route('profile') }}" class="{{ request()->routeIs('profile') ? 'active' : '' }}">Profile</a> </nav>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <div class="mobile-section-title">Akun</div>

    <!-- SECTION RIGHT ICON MENU -->
    <div class="mobile-account">
        <a href="{{ route('keranjang') }}"><span class="material-icons">shopping_cart</span> Keranjang</a>

        @auth
            <a href="{{ route('profile') }}"><span class="material-icons">person</span> Profile</a>
            <a href="{{ route('pesanan') }}"><span class="material-icons">inventory_2</span> Pesanan</a>
            <a href="{{ route('pesanan.history') }}"><span class="material-icons">history</span> Riwayat</a>
