...
<!-- Sambutan -->
<div class="sambutan">
    <h2>Selamat Datang di Katalog Pustaka</h2>
    <p>
        Halo <span class="nama">{{ Auth::user()->name }}</span>,
        selamat datang di <span class="tebal">Katalog Pustaka</span> — tempat dimana semua koleksi
