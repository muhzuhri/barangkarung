...
<div class="stats-grid">
    <div class="stat-card">
        <div class="stat-icon">
            <img src="img/img-dashboard/ds-user.png" alt="Icon Pengguna">
        </div>
    ...
    <div class="stat-card">
        <div class="stat-icon">
            <img src="img/img-dashboard/ds-user.png {{ asset('img/icon/down-icon.png') }}" alt="Icon Produk">
        </div>
    ...
    <div class="stat-card">
        <div class="stat-icon">
            <img src="/icons/orders.svg" alt="Icon Pesanan">
        </div>
    ...
    <div class="stat-card">
        <div class="stat-icon">
            <img src="/icons/revenue.svg" alt="Icon Pendapatan">
        </div>
