...
<form method="POST" action="{{ route('admin.users.store') }}" class="form-container">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <input type="password" id="password_confirmation" name="password_confirmation" class="form-input" placeholder="Pastikan isi dengan benar dan sama seperti password atas ... required>
        </div>
