...
<div class="user-profile">
    <div class="user-header">
        <div class="user-header-left">
            <div class="user-avatar-detail">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
        ...
        <div class="user-stats-detail">
            <div class="stat-item-detail">
                <span class="stat-number-detail">{{ $user->carts->count() }}</span>
                <span>Keranjang</span>
            </div>
            <div class="stat-item-detail">
                <span class="stat-number-detail">{{ $user->created_at->format('d/m/Y') }}</span>
                <span>Bergabung</span>
            </div>
        </div>
    </div>
