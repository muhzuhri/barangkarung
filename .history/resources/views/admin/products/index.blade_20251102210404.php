...
@if ($products->count() > 0)
    ...
    <a href="{{ route('admin.products.edit', $product->id) }}" class="btn-edit-katalog">Edit</a>
    <form method="POST" action="{{ route('admin.products.destroy', $product->id) }}"
        onsubmit="return confirm('Apakah Anda yakin ingin menghapus produk ini?')" style="margin: 0; flex: 1;">
        @csrf
        @method('DELETE')
        <button type="submit" class="btn-delete-katalog">Hapus</button>
    </form>
</div>
