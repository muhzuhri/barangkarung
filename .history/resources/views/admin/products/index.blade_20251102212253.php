                ...
                <div class="catalog-details">
                    ...
                    <div class="product-actions">
                        <a href="{{ route('admin.products.edit', $product->id) }}" class="btn-edit-katalog"
                            title="Edit Produk">
                            <img src="{{ asset('img/icon/ubah-icon.png') }}" alt="Edit" class="table-icon-katalog">Edit
                        </a>
                        ...
                        <form method="POST" action="{{ route('admin.products.destroy', $product->id) }}"
                            ...
                            <button type="submit" class="btn-delete-katalog" title="Hapus Produk">
                                <img src="{{ asset('img/icon/hapus-icon.png') }}" alt="Hapus" class="table-icon-katalog">Hapus
                            </button>
                        </form>
                    </div>
