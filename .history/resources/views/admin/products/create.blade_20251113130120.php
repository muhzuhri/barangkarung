...
<title>Tambah Produk Admin | BK</title>
...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="brand" name="brand" class="form-input" placeholder="Contoh : Uniqlo, H&M Dll..." required>
        </div>

        <div class="form-group">
            <label for="description" class="form-label">Deskripsi Produk :</label>
            <textarea id="description" name="description" class="form-textarea" rows="4" placeholder="Tuliskan deskripsi produk ..."></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="stock" name="stock" class="form-input" min="0" placeholder="Contoh Stok : 20" required>
        </div>
