...
<form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="form-container">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="brand" name="brand" class="form-input" value="{{ old('brand', $product->brand) }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="original_price" name="original_price" class="form-label" step="0.01"
