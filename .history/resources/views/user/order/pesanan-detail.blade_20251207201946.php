    ...
    <main class="order-detail">
        ...
        <div class="detail-card">
            <div class="detail-row">
                ...
                <!-- Status Pembayaran -->
                @php
                    // Semua metode transfer yang didukung, gunakan lowercase
                    $transferMethods = ['dana', 'mandiri', 'bca'];
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">
                        @if (in_array($paymentMethod, $transferMethods))
                            ...
                            @if ($order->payment_proof)
                                @php
                                    ...
                                    $proofUrl = $isCloudProof
                                        ? $order->payment_proof
                                        : asset('storage/' . $relativeProof);
                                @endphp
                                <a href="{{ $proofUrl }}" target="_blank">Lihat Bukti Transfer</a>
                            @endif
                            <br>
