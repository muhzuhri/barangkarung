...
<div class="transfer-box">
    <div class="transfer-label" id="rekeningLabel"></div>
    <div class="rekening-info" id="rekeningInfo"></div>

    <div id="qrisImageContainer" class="qris-container">
        <img id="qrisImage" src="" alt="QRIS" class="qris-image">
        <p id="qrisInstructions" class="qris-text"></p>
    </div>

    <div class="transfer-label">
        Upload Bukti Transfer
        <span class="transfer-optional-text">(Opsional - bisa upload nanti)</span>
    </div>

    <input type="file" name="payment_proof" accept="image/*" class="transfer-input-file">

    <small class="transfer-help-text">
