...
<head>
    ...
    {{-- Icon web & title --}}
    <title>Keranjang | Barang Karung</title>
...
<body>
    ...
    <section class="keranjang-container">
        @if ($cartItems->count() > 0)
            ...
            </div><div class="checkout-bar">
    <!-- LEFT: Pilih Semua + Checkout -->
    <div class="checkout-left">
        ...
        <!-- Checkout pindah ke baris ini -->
        <a href="#" class="checkout-btn" id="checkout-btn">Checkout (0)</a>
    </div>

    <!-- RIGHT: Hapus Semua (hanya tampil di desktop) -->
    <div class="checkout-right">
        <button class="clear-all-btn" id="clear-all">Hapus Semua</button>
    </div>
</div>
